...
But after a closer look -- it's usually the developer's mistake for writing something a silly way. tl&dr: It's great to be able to catch all of these issues at compile time and Rust does exactly that :muscle:
